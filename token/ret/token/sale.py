...
def get_exchangeable(ctx, sender_addr, sent_amount_neo, sending_time):
    ...
    WHITELIST_SALE_PERSONAL_CAP = get_config(ctx, 'WHITELIST_SALE_PERSONAL_CAP')
    PRESALE_PERSONAL_CAP = get_config(ctx, 'PRESALE_PERSONAL_CAP')
    CROWDSALE_PERSONAL_CAP = get_config(ctx, 'CROWDSALE_PERSONAL_CAP')
